...
public class ComponentImageV1
{
	...
	/**
	 * The docbook file name for an image is the ID of the image and the extension of the first language image. This
	 * does imply that you can not mix and match image formats within a single image.
