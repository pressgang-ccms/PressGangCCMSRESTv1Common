...
public class RESTFilterV1JSONConverter extends RESTBaseV1JSONConverter<RESTFilterV1> implements StringConverter<RESTFilterV1>
{
    public RESTFilterV1JSONConverter()
    {
        super(RESTFilterV1.class);
    }
}
