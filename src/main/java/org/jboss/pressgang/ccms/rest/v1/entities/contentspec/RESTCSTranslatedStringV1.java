...
public class RESTCSTranslatedStringV1 extends RESTBaseTranslatedStringV1<RESTCSTranslatedStringV1, RESTCSTranslatedStringCollectionV1, RESTCSTranslatedStringCollectionItemV1> {
    ...
    public boolean equals(final Object other)
    {
        ...
        if (this == other)
            return true;
        if (!(other instanceof RESTCSTranslatedStringV1))
            return false;
