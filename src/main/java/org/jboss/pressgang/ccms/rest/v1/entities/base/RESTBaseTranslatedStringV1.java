...
public abstract class RESTBaseTranslatedStringV1<T extends RESTBaseTranslatedStringV1<T, U, V>, U extends RESTBaseCollectionV1<T, U, V>, V extends RESTBaseCollectionItemV1<T, U, V>>
        extends RESTBaseEntityV1<T, U, V>
{
    ...
    public boolean equals(final Object other)
    {
        ...
        if (this == other)
            return true;
        if (!(other instanceof RESTBaseTranslatedStringV1))
            return false;
