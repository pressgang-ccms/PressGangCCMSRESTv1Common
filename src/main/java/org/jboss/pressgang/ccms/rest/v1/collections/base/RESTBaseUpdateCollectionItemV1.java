...
public abstract class RESTBaseUpdateCollectionItemV1<T extends RESTBaseEntityV1<T, U, V>, U extends RESTBaseCollectionV1<T, U, V>,
        V extends RESTBaseUpdateCollectionItemV1<T, U, V>> extends RESTBaseCollectionItemV1<T, U, V> {
