...
public class RESTCategoryInTagV1 extends RESTBaseCategoryV1<RESTCategoryInTagV1, RESTCategoryInTagCollectionV1, RESTCategoryInTagCollectionItemV1> implements ITagToCategoryV1
{
    ...
    public boolean equals(final Object other)
    {
        ...
        if (this == other)
            return true;
        if (!(other instanceof RESTCategoryInTagV1))
            return false;
