...
public class RESTPropertyCategoryV1JSONConverter extends RESTBaseV1JSONConverter<RESTPropertyCategoryV1> implements
        StringConverter<RESTPropertyCategoryV1> {
