...
public interface RESTInterfaceV1 extends RESTBaseInterfaceV1 {
    ...
    public String updateJSONPUsers(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTUserCollectionV1 dataObjects, @QueryParam("callback") final String callback)
    ...
    public RESTUserCollectionV1 updateJSONUsers(@QueryParam("expand") final String expand,
            final RESTUserCollectionV1 dataObjects) throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTUserV1 deleteJSONUser(@PathParam("id") final Integer id, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPStringConstant(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTStringConstantV1 dataObject, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPStringConstants(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTStringConstantCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTStringConstantV1 updateJSONStringConstant(@QueryParam("expand") final String expand,
            final RESTStringConstantV1 dataObject) throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPTranslatedTopic(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTTranslatedTopicV1 dataObject, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPTranslatedTopics(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTTranslatedTopicCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTTranslatedTopicV1 updateJSONTranslatedTopic(@QueryParam("expand") final String expand,
            final RESTTranslatedTopicV1 dataObject) throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPRoles(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTRoleCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTRoleCollectionV1 updateJSONRoles(@QueryParam("expand") final String expand,
            final RESTRoleCollectionV1 dataObjects) throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTRoleV1 deleteJSONRole(@PathParam("id") final Integer id, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPPropertyTag(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTPropertyTagV1 dataObject, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPPropertyTags(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTPropertyTagCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTPropertyTagCollectionV1 updateJSONPropertyTags(@QueryParam("expand") final String expand,
            final RESTPropertyTagCollectionV1 dataObjects) throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTPropertyTagV1 deleteJSONPropertyTag(@PathParam("id") final Integer id, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPPropertyCategory(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTPropertyCategoryV1 dataObject, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTPropertyCategoryV1 updateJSONPropertyCategory(@QueryParam("expand") final String expand,
            final RESTPropertyCategoryV1 dataObject) throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPBlobConstant(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTBlobConstantV1 dataObject, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPBlobConstants(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTBlobConstantCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTBlobConstantV1 updateJSONBlobConstant(@QueryParam("expand") final String expand,
            final RESTBlobConstantV1 dataObject) throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPProject(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTProjectV1 dataObject, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPProjects(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTProjectCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTProjectCollectionV1 updateJSONProjects(@QueryParam("expand") final String expand,
            final RESTProjectCollectionV1 dataObjects) throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTProjectV1 deleteJSONProject(@PathParam("id") final Integer id, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPTags(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTTagCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTTagV1 deleteJSONTag(@PathParam("id") final Integer id, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTTagCollectionV1 deleteJSONTags(@PathParam("ids") final PathSegment ids, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPCategory(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTCategoryV1 dataObject, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPCategories(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTCategoryCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTCategoryCollectionV1 updateJSONCategories(@QueryParam("expand") final String expand,
            final RESTCategoryCollectionV1 dataObjects) throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTCategoryV1 deleteJSONCategory(@PathParam("id") final Integer id, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPImages(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTImageCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTImageCollectionV1 updateJSONImages(@QueryParam("expand") final String expand,
            final RESTImageCollectionV1 dataObjects) throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTImageV1 deleteJSONImage(@PathParam("id") final Integer id, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPTopics(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTTopicCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTTopicCollectionV1 updateJSONTopics(@QueryParam("expand") final String expand,
            final RESTTopicCollectionV1 dataObjects) throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTTopicV1 deleteJSONTopic(@PathParam("id") final Integer id, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPFilter(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTFilterV1 dataObject, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPFilters(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTFilterCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTFilterCollectionV1 updateJSONFilters(@QueryParam("expand") final String expand,
            final RESTFilterCollectionV1 dataObjects) throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTFilterV1 deleteJSONFilter(@PathParam("id") final Integer id, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPIntegerConstant(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTIntegerConstantV1 dataObject, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPIntegerConstants(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTIntegerConstantCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTIntegerConstantV1 updateJSONIntegerConstant(@QueryParam("expand") final String expand,
            final RESTIntegerConstantV1 dataObject) throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPContentSpec(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTContentSpecV1 dataObject, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPContentSpecs(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTContentSpecCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTContentSpecCollectionV1 updateJSONContentSpecs(@QueryParam("expand") final String expand,
            final RESTContentSpecCollectionV1 dataObjects) throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTContentSpecV1 deleteJSONContentSpec(@PathParam("id") final Integer id, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPContentSpecNode(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTCSNodeV1 dataObject, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPContentSpecNodes(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTCSNodeCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTCSNodeCollectionV1 updateJSONContentSpecNodes(@QueryParam("expand") final String expand,
            final RESTCSNodeCollectionV1 dataObjects) throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTCSNodeV1 deleteJSONContentSpecNode(@PathParam("id") final Integer id, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPContentSpecMetaData(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTCSMetaDataV1 dataObject, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public String updateJSONPContentSpecMetaDatas(@QueryParam("expand") final String expand,
            @QueryParam("data") final RESTCSMetaDataCollectionV1 dataObjects, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
