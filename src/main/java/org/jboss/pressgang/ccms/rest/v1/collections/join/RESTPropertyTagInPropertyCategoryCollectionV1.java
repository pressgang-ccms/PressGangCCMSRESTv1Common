 ...
 */
public class RESTPropertyTagInPropertyCategoryCollectionV1 extends RESTBaseEntityUpdateCollectionV1<RESTPropertyTagInPropertyCategoryV1,
        RESTPropertyTagInPropertyCategoryCollectionV1, RESTPropertyTagInPropertyCategoryCollectionItemV1> {
    private List<RESTPropertyTagInPropertyCategoryCollectionItemV1> items = new
            ArrayList<RESTPropertyTagInPropertyCategoryCollectionItemV1>();
    ...
    protected void ignoreDuplicatedChangeItemRequests() {
        if (getItems() != null) {
            final List<RESTPropertyTagInPropertyCategoryCollectionItemV1> items = new
                    ArrayList<RESTPropertyTagInPropertyCategoryCollectionItemV1>(getItems());
