...
public class RESTCSRelatedNodeCollectionV1 extends RESTBaseUpdateCollectionV1<RESTCSRelatedNodeV1, RESTCSRelatedNodeCollectionV1, RESTCSRelatedNodeCollectionItemV1> {
                ...
                for (int j = i + 1; j < items.size(); ++j)
                {
                    ...
                    if (childItem1.getId().equals(childItem2.getId()) && relationshipIdEqual)
                    {
                        ...
                        final boolean typeEqual = childItem1.getRelationshipType() == null && childItem2.getRelationshipType() == null 
                                || childItem1.getRelationshipType() != null && childItem1.getRelationshipType().equals(childItem2.getRelationshipType());
