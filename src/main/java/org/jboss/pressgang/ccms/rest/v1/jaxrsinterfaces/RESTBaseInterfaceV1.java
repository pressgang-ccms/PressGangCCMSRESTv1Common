...
public interface RESTBaseInterfaceV1 {
    ...
    public String updateJSONPUser(@QueryParam("expand") final String expand, @QueryParam("data") final RESTUserV1 dataObject,
            ...
            @QueryParam("userId") final String userId, @QueryParam("callback") final String callback)
            throws InvalidParameterException, InternalProcessingException;
    ...
    public RESTUserCollectionV1 deleteJSONUsers(@PathParam("ids") final PathSegment ids,
            @QueryParam("message") final String message, @QueryParam("flag") final Integer flag,
            @QueryParam("userId") final String userId, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTStringConstantV1 getJSONStringConstantRevision(@PathParam("id") final Integer id,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTTranslatedTopicV1 getJSONTranslatedTopicRevision(@PathParam("id") final Integer id,
            @PathParam("rev") final Integer revision, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTPropertyTagV1 getJSONPropertyTagRevision(@PathParam("id") final Integer id,
            @PathParam("rev") final Integer revision, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTBlobConstantV1 getJSONBlobConstantRevision(@PathParam("id") final Integer id,
            @PathParam("rev") final Integer revision, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTIntegerConstantV1 getJSONIntegerConstantRevision(@PathParam("id") final Integer id,
            @PathParam("rev") final Integer revision, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTContentSpecV1 getJSONContentSpecRevision(@PathParam("id") final Integer id,
            @PathParam("rev") final Integer revision, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTCSNodeV1 getJSONContentSpecNodeRevision(@PathParam("id") final Integer id,
            @PathParam("rev") final Integer revision, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public String getJSONPContentSpecMetaDataRevision(@PathParam("id") final Integer id,
            @PathParam("rev") final Integer revision, @QueryParam("expand") final String expand,
            @QueryParam("callback") final String callback) throws InvalidParameterException, InternalProcessingException;
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes({ "*" })
    public RESTCSMetaDataV1 getJSONContentSpecMetaDataRevision(@PathParam("id") final Integer id,
            @PathParam("rev") final Integer revision, @QueryParam("expand") final String expand)
            throws InvalidParameterException, InternalProcessingException;
