...
for package in ${WRAPPERS} ${COLLECTIONS} ${COLLECTIONS_ITEMS} ${COLLECTIONS_JOIN} ${ELEMENTS} ${ENTITIES} ${ENTITIES_ENUMS} ${ENTITIES_JOIN} ${COLLECTIONS_ITEMS_JOIN} ${COLLECTIONS_CONTENTSPEC} ${ENTITIES_CONTENTSPEC} ${ENTITIES_CONTENTSPEC_ENUMS} ${ENTITIES_CONTENTSPEC_JOIN} ${COLLECTIONS_CONTENTSPEC_JOIN} ${COLLECTIONS_CONTENTSPEC_ITEMS}
do
	for file in $package
	do		
		if [ -f $file ]
